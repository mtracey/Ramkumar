<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiProjectAssigned.aspx.cs" Inherits="SMEPayroll.Management.MultiProjectAssigned"  %>
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Project Assigned<asp:Label ID="lblProjectType" runat="server" Text=""></asp:Label></b></font>
                            </td>
                        </tr>
                                ...
                                <table id="table4" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="display:block">
                                            <asp:CheckBox AutoPostBack="true" OnCheckedChanged="Check_Change1" ID="chkMulti" runat="server" />
                                        </td>
                                        ...
                                        <td>
                                            <asp:Button ID="btnInsert" runat="server" CssClass="textfields" Text="Assign Projects" OnClick="btnInsert_Click" /></td>
                                        <td>
                                            <asp:Button ID="btnMove" runat="server" CssClass="textfields" Text="Move Projects" OnClick="btnMove_Click" /></td>
                                        <td>
                                            <asp:Button ID="btnDelete" runat="server" CssClass="textfields" Text="Un Assigned Projects" OnClick="btnDelete_Click" /></td>
                                        <td>
                                                        ...
                                                        <table id="table3" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                ...
                                                                <td valign="top" colspan="7" align="left">
                                                                    <radG:RadGrid ID="rdException" runat="server" GridLines="None" Skin="Outlook"
                                                                        Width="50%" AllowFilteringByColumn="true" AllowMultiRowSelection="true" PagerStyle-Mode="NumericPages"
                                                                        ShowFooter="False">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                     <td style="width: 100%; height: 21px;" align="center">
                                        <font face="verdana" size="2"><asp:Label  ForeColor="Red" ID="lblLoading" runat="server" Text=""></asp:Label></font>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                   <tr>
                                                   ...
                                                   <td style="width: 100%">
                                                       <asp:DataList ID="DataList1" runat="server" DataKeyField="ID" 
                                                           ...
                                                           <ItemTemplate>
                                                               ...
                                                               <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                   <tr>
                                                                       ...
                                                                       <td align="left" style="width: 91%">
                                                                           <font face="verdana" size="2">&nbsp;<asp:Label ID="Label1" runat="server" 
                                                                               Font-Size="small" Text='<%# Bind("Sub_Project_Name") %>'></asp:Label>
                                                               ...
                                                               <!-- End header grid -->
                                                               <!--AllowFilteringByColumn="true"--><font face="verdana" size="2">
                                                               <radG:RadGrid ID="GridView1" runat="server" AllowMultiRowSelection="true" 
                                                                   GridLines="None" Height="240px" PagerStyle-Mode="NumericPages" 
                                                                   ShowFooter="False" Skin="Outlook" Visible="true" Width="98%">
                                                                   <mastertableview allowautomaticupdates="True" autogeneratecolumns="False" 
                                                                       ...
                                                                       <AlternatingItemStyle BackColor="#E5E5E5" Height="20px" />
                                                                       <Columns>
                                                                           <radG:GridBoundColumn CurrentFilterFunction="contains" DataField="Emp_Code" 
                                                                               DataType="System.Int32" Display="false" HeaderText="Emp_Code" ReadOnly="True" 
                                                                               SortExpression="Emp_Code" UniqueName="Emp_Code" Visible="true">
                                                                           </radG:GridBoundColumn>
                                                                           <radG:GridClientSelectColumn UniqueName="Assigned">
                                                                               <ItemStyle Width="2%" />
                                                                           </radG:GridClientSelectColumn>
                                                                           <radG:GridBoundColumn AutoPostBackOnFilter="true" 
                                                                               CurrentFilterFunction="contains" DataField="Time_Card_NO" 
                                                                               DataType="System.String" HeaderText="Card No" ReadOnly="True" 
                                                                               ShowFilterIcon="false" SortExpression="Time_Card_NO" UniqueName="Time_Card_NO" 
                                                                               Visible="true">
                                                                           </radG:GridBoundColumn>
                                                                           <radG:GridBoundColumn AutoPostBackOnFilter="true" 
                                                                               CurrentFilterFunction="contains" DataField="FullName" DataType="System.String" 
                                                                               HeaderText="Employee Name" ShowFilterIcon="false" SortExpression="FullName" 
                                                                   ...
                                                                   <clientsettings enablerowhoverstyle="true">
                                                                       <Selecting AllowRowSelect="True" />
                                                                       <Scrolling AllowScroll="True" FrozenColumnsCount="1" 
                                       ...
                                       <td style="height: 21px" valign="top">
                                           <table ID="tblUnEmp" runat="server" border="0" cellpadding="0" cellspacing="0" 
                                               ...
                                               <tr>
                                                   ...
                                                   <td align="left" style="width: 91%">
                                                       <font face="verdana" size="2">&nbsp;<asp:Label ID="lblSummary" runat="server" 
                                                           Font-Size="small" Text="Project Summary">
                                        </asp:Label>
                                                       </font>
                                                   </td>
                                               </tr>
                                               ...
                                               <tr>
                                                   <td colspan="2">
                                                       <table ID="tblSummary" runat="server" border="0" cellpadding="0" 
                                                           cellspacing="0" style="table-layout: fixed; height: 240px" width="100%">
                                                           <tr>
                                                               <td valign="top">
                                                                   <radG:RadGrid ID="rdSummary" runat="server" AllowFilteringByColumn="false" 
                                                                       GridLines="None" Height="240px" OnItemDataBound="rdSummary_databound" 
                                                                       ShowFooter="False" Skin="Outlook" Width="98%">
                                                                       <mastertableview autogeneratecolumns="False">
                                                                           ...
                                                                           <Columns>
                                                                               <radG:GridBoundColumn DataField="TType" DataType="System.string" 
                                                                                   HeaderText="Type" SortExpression="TType" UniqueName="TType" Visible="true">
                                                                               </radG:GridBoundColumn>
                                                                               <radG:GridBoundColumn DataField="Locals" DataType="System.Int32" 
                                                                                   HeaderText="Local" SortExpression="Locals" UniqueName="Locals" Visible="true">
                                                                               </radG:GridBoundColumn>
                                                                               <radG:GridBoundColumn DataField="Foreigners" DataType="System.Int32" 
                                                                                   HeaderText="Foreign" SortExpression="Foreigners" UniqueName="Foreigners" 
                                                                                   Visible="true">
                                                                               </radG:GridBoundColumn>
                                                                               <radG:GridBoundColumn DataField="Total" DataType="System.Int32" 
                                                                                   HeaderText="Total" SortExpression="Total" UniqueName="Total" Visible="true">
                                                                               </radG:GridBoundColumn>
                                                                           </Columns>
                                                                       </mastertableview>
                                                                       <clientsettings enablerowhoverstyle="true">
                                               ...
                                               <tr>
                                                   ...
                                                   <td align="left" style="width: 91%">
                                                       <font face="verdana" size="2">&nbsp;<asp:Label ID="lblUn" runat="server" 
                                                           Font-Size="small" Text="Unassigned Project">
                                        </asp:Label>
                                                       </font>
                                                   </td>
                                               </tr>
                                               ...
                                               <tr>
                                                   <td colspan="2">
                                                       <%--<asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                                           <ContentTemplate>--%>
                                                               <radG:RadGrid ID="rdEmployee" runat="server" AllowFilteringByColumn="true"  
                                                                   AllowMultiRowSelection="true" AllowSorting="true" GridLines="None" 
                                                                   OnItemDataBound="rdEmployee_databound" 
                                                                   OnNeedDataSource="rdEmployee_NeedDataSource" 
                                                                   OnPageIndexChanged="rdEmployee_PageIndexChanged" PagerStyle-Mode="NumericPages" 
                                                                   Skin="Outlook" Visible="False" Width="98%">
                                                                   <mastertableview allowautomaticupdates="True" allowpaging="true"  
                                                                       autogeneratecolumns="False" datakeynames="Emp_Code,Emp_ID" pagesize="10000">
                                                                       <FilterItemStyle HorizontalAlign="left" />
                                                                       <HeaderStyle ForeColor="Navy" />
                                                                       <ItemStyle BackColor="White" Height="20px" />
                                                                       <AlternatingItemStyle BackColor="#E5E5E5" Height="20px" />
                                                                       <Columns>
                                                                           <radG:GridBoundColumn DataField="Emp_Code" DataType="System.Int32" 
                                                                           ...
                                                                           <radG:GridBoundColumn AutoPostBackOnFilter="true" DataField="Time_Card_NO" 
                                                                               DataType="System.String" HeaderText="Card No" ReadOnly="True" 
                                                                               ShowFilterIcon="false" SortExpression="Time_Card_NO" UniqueName="Time_Card_NO" 
                                                                               Visible="true">
                                                                           </radG:GridBoundColumn>
                                                                           <radG:GridBoundColumn AutoPostBackOnFilter="true" DataField="FullName" 
                                                                               DataType="System.String" HeaderText="Employee Name" ShowFilterIcon="false" 
