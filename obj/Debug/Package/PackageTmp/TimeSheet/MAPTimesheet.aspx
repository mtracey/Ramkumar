                    ...
                    <table style="vertical-align: middle;" width="50%"  align="center" cellpadding="1" cellspacing="0" border="0">
                        ...
                        <tr id="row4" runat="server" visible="false">
                         ...
                         <tr id="row5" runat="server" visible="false">
                            ...
                            <td colspan="2">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drpUserid" runat="server" CssClass="textfields"
                                        Width="60%">
                                    </asp:DropDownList>
                        ...
                        <tr id="row6" runat="server" visible="false">
                            ...
                            <td colspan="2">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drpProjectSingle" runat="server" CssClass="textfields"
                                        Width="60%">
                                    </asp:DropDownList>
                        ...
                        <tr id="row7" runat="server" visible="false">
                            ...
                            <td colspan="2">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drptimesheetdateSingle" runat="server" CssClass="textfields"
                                        Width="60%">
                                    </asp:DropDownList>
                        ...
                        <tr id="row9" runat="server" visible="false">
                            ...
                            <td colspan="2">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drptimesheettimeInSingle" runat="server" CssClass="textfields"
                                        Width="60%">
                                    </asp:DropDownList>
                         ...
                         <tr id="row8" runat="server" visible="false">
                            ...
                            <td colspan="2">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drptimesheetdateoutSingle" runat="server" CssClass="textfields"
                                        Width="60%">
                                    </asp:DropDownList>
                        ...
                        <tr id="row10" runat="server" visible="false">
                            ...
                            <td colspan="2">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drptimesheettimeOutSingle" runat="server" CssClass="textfields" Width="60%"></asp:DropDownList>
                        ...
                        <tr id="row11" runat="server" visible="false">
                            ...
                            <td colspan="2"  visible="false">
                                <tt class="bodytxt">
                                    <asp:DropDownList AutoPostBack="true" ID="drpTimeSheetDate" runat="server" CssClass="textfields" Width="60%"></asp:DropDownList>
                        ...
                        <tr >
                            ...
                            <td align="center"  colspan="1">
                                <asp:Button ID="btnSave" runat="server"  Text="Import Leaving Invalid Rows"/>
                            </td>
                            <td align="left"  colspan="1"> 
                                <asp:Button ID="btnCancel" runat="server" Text="Cancel Import"/>
                            </td>
                            <td align="left"  colspan="1"> 
