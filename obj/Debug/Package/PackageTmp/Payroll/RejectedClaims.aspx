                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>View Rejected Claims</b></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
            ...
            <tr>
                <td>
                    <radG:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                        Skin="Outlook" Width="99%" EnableHeaderContextMenu="true">
...
and e.emp_code = b.emp_code and claimstatus='Rejected' and e.emp_code=@emp_code and year(trx_period)=@year  and upper(a.optionselection) like '%CLAIM%'"
