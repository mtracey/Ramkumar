<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Emp_BulkDed.aspx.cs" Inherits="SMEPayroll.Payroll.Emp_BulkDed" %>
                            ...
                            <tr>
                                <td >
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tr>
                                            <td >
                                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Employee Multi Deductions</b></font>
                                            </td>
                                            <td align="center">
            ...
            <telerik:RadPane ID="gridPane2" runat="server" Width="100%" Height="100%"   Scrolling="None" BorderWidth="0px">
             <!-- grid -->
               ...
               <telerik:RadGrid  ID="RadGrid1" runat="server" AutoGenerateColumns="false" ShowStatusBar="false"
                        ...
                        >
                        <MasterTableView DataKeyNames="Emp_Code, Time_Card_No"  ShowFooter="true" >
                        ...
                        <AlternatingItemStyle  Height="25px" VerticalAlign="middle" />
                         <HeaderStyle Wrap="false" Height="25px" />
                            <Columns>
                                ...
                                <telerik:GridBoundColumn  DataField="FullName" UniqueName="FullName" HeaderText="(109)FullName">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" background="../frames/images/toolbar/backs.jpg"  Height="32px" id="TabId" runat="server" visible="false"  >
                        <tr>
                            ...
                            <td style="width:60%;" align="center"> <asp:Button Visible="false" ID="btnUpdate" Text="Update" runat="server" OnClick="btnUpdate_Click" CssClass="textfields" Style="width: 180px;height: 22px" /> </td>
                        </tr>
                    </table>
            <!-- End grid -->  
            </telerik:RadPane>
