        ...
        <telerik:RadSplitter ID="RadSplitter1" Width="100%" Height="100%" runat="server" 
                    ...
                    <telerik:RadPane ID="Radpane111" runat="server" Scrolling="none" >
                        <!-- top -->
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" background="../frames/images/toolbar/backs.jpg" Height="32px" >
                                <tr>
                                    <td>
                                        <table cellpadding="05" cellspacing="0" width="100%" border="0" >
                                            <tr>
                                                <td>
                                                    <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Print Payroll</b></font>
                                                </td>
                                                <td align="center">
                                    ...
                                    <%--                <asp:DropDownList ID="cmbYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbYear_selectedIndexChanged"
                                                    ...
                                                    </asp:SqlDataSource><%--OnClick="bindgrid"--%>
                                                    &nbsp;<tt><asp:ImageButton ID="imgbtnfetch" OnClick="bindGrid1"
            ...
            PagerStyle-Mode="Advanced" 
             >
                ...
                <Columns>
                    <radG:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn" HeaderText="106">
                        <ItemTemplate>
                    ...
                    <radG:GridBoundColumn DataField="emp_name" HeaderText="Employee Name" SortExpression="emp_name"
                        UniqueName="emp_name" ShowFilterIcon="false" HeaderStyle-Wrap="false" HeaderStyle-Width="200px" AutoPostBackOnFilter="true">
                    </radG:GridBoundColumn>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%" background="../frames/images/toolbar/backs.jpg"  Height="32px" id="TabId" runat="server"  >
                        <tr>
                            ...
                            <td style="width:40%;color:White;" >
                                <tt class="bodytxt">Epayslip will not be emailed<br />
                               to employees whose email address is not available in the system.</tt>
                            </td>
                           <td align="center">
                                <asp:Button ID="Button6" runat="server" Text="Print Selected Payslip" class="textfields" Style="width: 160px;
                                    height: 23px" OnClick="PrintPayrollSel_Click" />
                                <asp:Button ID="Button2" runat="server" Text="Print Payslip" class="textfields" Style="width: 160px;
                                    height: 23px" OnClick="PrintPayroll_Click" />
                                <asp:Button ID="Button3" runat="server" Text="Email Payslip" class="textfields" Style="width: 160px;
