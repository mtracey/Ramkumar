                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Timesheet Supervisor Assignment</b></font>
                            </td>
                        </tr>
                        <tr bgcolor="<% =sOddRowColor %>">
                         <td   valign="middle" align="CENTER">
                           <tt class="bodytxt"> Timesheet Supervisor :</tt> <asp:DropDownList Width="200px" OnDataBound="drpSubProjectID_databound" ID="drpSubProjectID"
