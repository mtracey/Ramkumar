        ...
        void bindata()
        {
            ...
            if (rdStart.SelectedDate != null)
            {
                ...
                #region DataList
                    ...
                    string sSQL1 = "Select SP.ID,SP.Sub_Project_Name From SubProject SP Inner Join Project PR On SP.Parent_Project_ID = PR.ID Left Outer Join Location LO On PR.Location_ID = LO.ID Where (LO.Company_ID=" + comp_id.ToString() + "  OR LO.isShared='YES') AND SP.Active=1";
