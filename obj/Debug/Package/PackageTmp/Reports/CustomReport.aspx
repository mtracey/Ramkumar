...
<body style="margin-left: auto">
    <form id="employeeform" runat="server" method="post">
        ...
        <div>
            <radG:RadGrid ID="empResults" runat="server" GridLines="None" ShowGroupPanel="true"
                ...
                <MasterTableView AllowAutomaticUpdates="True" AllowSorting="FALSE" AllowFilteringByColumn="true"
                    ...
                    <GroupByExpressions>
                        <telerik:GridGroupByExpression>
                            <selectfields>
                            <telerik:GridGroupByField FieldAlias="Category" FieldName="Category" FormatString="{0:D}"
