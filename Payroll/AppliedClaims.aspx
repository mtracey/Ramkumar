...
<body style="margin-left: auto">
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Claim Status</b></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
                            <td align="center">
            ...
            <tr>
                <td>
                    <radG:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                        Skin="Outlook" Width="99%" OnItemDataBound="RadGrid1_ItemDataBound" OnUpdateCommand="RadGrid1_UpdateCommand" EnableHeaderContextMenu="true">
                        <MasterTableView DataSourceID="SqlDataSource2" AllowAutomaticDeletes="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <radG:GridTemplateColumn HeaderText="Period(MM/DD/YYYY)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblperiod" Text='<%# DataBinder.Eval(Container,"DataItem.trx_period")%>'
                                ...
                                <radG:GridEditCommandColumn UpdateText="Update" EditText="Edit" CancelText="Cancel"
                                    ButtonType="ImageButton" InsertImageUrl="../frames/images/toolbar/edit.gif" HeaderText="Edit">
                                    <ItemStyle Width="1%" />
                                </radG:GridEditCommandColumn>
                                <radG:GridButtonColumn HeaderText="Delete" ButtonType="ImageButton" ConfirmText="Are you sure you want to cancel this Claims?"
        ...
        e.[trx_id],  a.[id],a.[desc] ,e.[trx_amount],convert(varchar(20),trx_period,101) trx_period,            
...
and e.emp_code = b.emp_code and claimstatus is not null and e.emp_code=@emp_code and year(trx_period)=@year  and upper(a.optionselection) like '%CLAIM%'"
