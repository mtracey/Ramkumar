...
<body style="margin-left: auto">
    <form id="employeeform" runat="server" method="post">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Assign Users Rights</b></font>
                            </td>
                        </tr>
        ...
        <div class="exampleWrapper">
            &nbsp;&nbsp;&nbsp;<asp:Label Font-Bold="true" Font-Size="12px"   ID="lblUserGroup" runat="server" Text="" CssClass="bodytxt"></asp:Label>
            <telerik:RadTabStrip ID="RadTabStrip1" SelectedIndex="0" runat="server" MultiPageID="RadMultiPage1"
                CssClass="NoBg" Skin="Outlook" Orientation="VerticalLeft" Style="float: left">
            </telerik:RadTabStrip>
            <telerik:RadMultiPage ID="RadMultiPage1" Width="80%" Height="100%" CssClass="multiPage"
