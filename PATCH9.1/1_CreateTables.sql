...
IF EXISTS ( SELECT  *
   ...
   DROP TRIGGER [dbo].[ACTATEK_LOGS_MACHINE_TRIGGER]
...
(
	...
	AND TABLE_NAME='DataBaseBackupLog'
) 
	DROP TABLE DataBaseBackupLog
ELSE 
	/****** Object:  Table [dbo].[DataBaseBackupLog]    Script Date: 11/24/2010 17:48:24 ******/
	SET ANSI_NULLS ON
	GO
	SET QUOTED_IDENTIFIER ON
	GO
...
/****** Object:  Table [dbo].[ClientDetails]    Script Date: 05/18/2011 13:48:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--- Trade Table for Trade Names And All


/****** Object:  Table [dbo].[PaymentType]    Script Date: 05/18/2011 13:53:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF EXISTS ( SELECT  name
            FROM    sysobjects
            WHERE   name = N'PaymentType' AND
                    xtype = 'U' ) 
SET @exist = 1
IF (@exist = 0)
CREATE TABLE [dbo].[PaymentType](
	[TypeID] [int] NOT NULL,  --pk
...
/****** Object:  Table [dbo].[ProjectPaymentAdv]    Script Date: 05/18/2011 13:58:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF EXISTS ( SELECT  name
            FROM    sysobjects
            WHERE   name = N'ProjectPaymentAdv' AND
                    xtype = 'U' ) 
SET @exist = 1
IF (@exist = 0)
CREATE TABLE [dbo].[ProjectPaymentAdv](
	[ID] [nchar](10) NOT NULL,
	[ProjectID] [int] NOT NULL,   --FK To SubProjectID.ID From SubProject Table 
	[PaymentTypeID] [int] NOT NULL, ---FK to PaymentType.ID 
	[Amount] [numeric](18, 0) NOT NULL,
 CONSTRAINT [PK_ProjectPaymentAdv] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
/****** Object:  Table [dbo].[Quotation_Client]    Script Date: 05/18/2011 14:03:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF EXISTS ( SELECT  name
            FROM    sysobjects
            WHERE   name = N'Quotation_Client' AND
                    xtype = 'U' ) 
SET @exist = 1
IF (@exist = 0)
CREATE TABLE [dbo].[Quotation_Client](
	[QID] [int] NOT NULL,
	[QuotationName] [varbinary](max) NOT NULL,
	[ClientID] [int] NOT NULL,--- FK To ClientDetails.ClientID
 CONSTRAINT [PK_Quotation_Client] PRIMARY KEY CLUSTERED 
(
	[QID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
IF EXISTS ( SELECT  name
            FROM    sysobjects
            WHERE   name = N'QuotationDetails' AND
                    xtype = 'U' ) 
SET @exist = 1
IF (@exist = 0)
CREATE TABLE [dbo].[QuotationDetails](
	[ID] [int] NOT NULL,
	[QuotationID] [int] NOT NULL, ----FK TO Quotation_Client.[QID]
	[TradeID] [int] NOT NULL,  ---FK To Trade.ID
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'FK To ''Quotation_Client'' QID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'QuotationDetails', @level2type=N'COLUMN',@level2name=N'QuotationID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'FK To Trade table (ID Column)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'QuotationDetails', @level2type=N'COLUMN',@level2name=N'TradeID'
...
/****** Object:  Table [dbo].[OrderQuotationProject]    Script Date: 05/18/2011 14:15:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF EXISTS ( SELECT  name
            FROM    sysobjects
            WHERE   name = N'OrderQuotationProject' AND
                    xtype = 'U' ) 
SET @exist = 1
IF (@exist = 0)
CREATE TABLE [dbo].[OrderQuotationProject](
	[OrderID] [int] NOT NULL,
	[OrderName] [varchar](1000) NOT NULL,
	[QuotationID] [int] NOT NULL, --FK Quotation_Client.QID
---	[ProjectID] [int] NOT NULL,		
	[Remark] [varbinary](max) NULL
 CONSTRAINT [PK_OrderQuotationProject] PRIMARY KEY CLUSTERED 
(
	[OrderID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'[QID] From Quotation_Client ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'OrderQuotationProject', @level2type=N'COLUMN',@level2name=N'QuotationID'
