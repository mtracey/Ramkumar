                    ...
                    <td>
                        <table cellpadding="2" cellspacing="2" border="0" style="width: 100%; height: 100%;">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <tt class="colnamebold">Day Rate($):</tt></td>
                                <td align="left">
                                    <tt class="bodytxt" style="text-align: left">
                                        <asp:Label ID="lblDayRate" runat="server" Text="-"></asp:Label></tt></td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td align="left">
                                    <tt class="bodytxt" style="text-align: left">
                                        <asp:Label ID="lblHrRate" runat="server" Text="-"></asp:Label></tt></td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <tt class="bodytxt" style="text-align: left">
                                        <asp:Label ID="lblActWorkDaysInRoll" runat="server" Text="-"></asp:Label></tt></td>
                                <td align="right">
                                    <tt class="colnamebold">UnPaid Leaves:</tt></td>
                                <td align="left">
                                    <tt class="bodytxt" style="text-align: left">
                                        <asp:Label ID="lblUnpaid" runat="server" Text="-"></asp:Label></tt></td>
                            </tr>
                        </table>
                        <hr />
                    </td>
