                ...
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            ...
                            <br />
                            <tt class="bodytxt">Apply Leave and submit for approval to your supervisor,<br />
                        ...
                        <td style="width: 41%; text-align: left">
                            ...
                            <br />
                            <tt class="bodytxt">View the status of all the leave's applied.</tt></td>
                        <%}%>
                    </tr>
                </table>
            </center>
                ...
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            ...
                            <br />
                            <tt class="bodytxt">View all the Approved leave's.</tt><br />
                        </td>
                        <%}
                        ...
                        <td style="width: 41%; text-align: left">
                            ...
                            <br />
                            <tt class="bodytxt">View all the Rejected leave's.</tt></td>
                        <%}%>
                    </tr>
                </table>
            </center>
                ...
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            ...
                            <br />
                            <tt class="bodytxt">Manage your employee's leave information. Approve or reject<br />
                                submitted leave's.</tt><br />
                        </td>
                        <%}
                          else
                          {%>
                        ...
                        <td style="width: 41%; text-align: left">
                            ...
                            <br />
                            <tt class="bodytxt">Manage leaves allowed based on Employee Group. Add
                                <br />
                                new leaves allowed or update the existing information.</tt></td>
                        <%}%>
                    </tr>
                </table>
            </center>
            ...
            <center>
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../Leaves/LeaveTransfer.aspx" class="nav"><b>Leave Transfer </b></a>
                            <br />
                            <tt class="bodytxt">Tranfering the leaves from year to year.</tt></td>
                        <%}%>
                    </tr>
                </table>
            </center>
            ...
            <center>
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../Leaves/PublicHolidays.aspx" class="nav"><b>Manage Holidays</b></a><br />
                            <tt class="bodytxt">View existing National Holidays. Add new Holidays information.</tt><br />
                        </td>
                        <%}
                          else
                          {%>
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../Leaves/LeaveAddDed.aspx" class="nav"><b>Manage Leaves</b></a><br />
                            <tt class="bodytxt">Global Update for Leave Additons and Deductions.</tt></td>
                        <%}%>
                    </tr>
                </table>
            </center>
