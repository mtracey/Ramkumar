...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <center>
            <table style="width: 352px; height: 184px">
                <tr>
                   <td class ="bodytxt">
                        Username:</td>
                ...
                <tr bgcolor="<% =sOddRowColor%>">
                    <td class ="bodytxt">
                        Current Password:</td>
                    <td align="left">
                        <asp:TextBox  Width="190px" TextMode=Password ID="txtopwd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr bgcolor="<% =sOddRowColor%>">
                    <td class ="bodytxt">
                        New Password:</td>
                    <td align="left">
                        <asp:TextBox  Width="190px" TextMode=Password  ID="txtnpwd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr bgcolor="<% =sOddRowColor%>">
                    <td class ="bodytxt">
                        Confirm Password:</td>
                    <td align="left">
                        <asp:TextBox  Width="190px" TextMode=Password  ID="txtcpwd" runat="server"></asp:TextBox>
                    </td>
                </tr>
