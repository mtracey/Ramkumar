...
GO
	...
	Insert Into HourTransfer values (10, 'NH')
GO
...
INSERT TABLEOBJATTRIB(ID,TableID,Field_Type,Field_Width,Field_Name,Alias_Name,Table_Source,Group_Source,GroupColumn)       VALUES('97','2','General','200','fund_type','fund_type','','','')
INSERT TABLEOBJATTRIB(ID,TableID,Field_Type,Field_Width,Field_Name,Alias_Name,Table_Source,Group_Source,GroupColumn)       VALUES('98','2','Number','8','fund_amount','fund_amount','','','')

SET IDENTITY_INSERT TABLEOBJATTRIB OFF
GO

DELETE FROM RightsHeader
...
if not exists(select * from [RightsHeader] where [RightId]=9) INSERT INTO [RightsHeader]([RightId],[RightHeader])VALUES(9,'Help')
if not exists(select * from [RightsHeader] where [RightId]=10) INSERT INTO [RightsHeader]([RightId],[RightHeader])VALUES(10,'Invoice')

if not exists(select * from [RightsHeader] where [RightId]=11) INSERT INTO [RightsHeader]([RightId],[RightHeader])VALUES(11,'Backup logs')
if not exists(select * from [RightsHeader] where [RightId]=12) INSERT INTO [RightsHeader]([RightId],[RightHeader])VALUES(12,'Status Bar')
...
Set @count = 0
Select @count=COUNT(ID) from DropDowns where UPPER([DropDown])  = 'MultiAdditionMapping'
If (@count = 0)
Begin
	Insert into DropDowns(DropDown, Navigate) values('MultiAdditionMapping', '../Management/MappingExcel_MultiAddition.aspx')
End


Set @count = 0
Select @count=COUNT(ID) from DropDowns where UPPER([DropDown])  = 'MultiDeductionMapping'
If (@count = 0)
Begin
	Insert into DropDowns(DropDown, Navigate) values('MultiDeductionMapping', '../Management/MappingExcel_MultiDeduction.aspx')
End
...
--2012
SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '01/02/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-01-02 00:00:00.000','New Years Day', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '01/23/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-01-23 00:00:00.000','Chinese New Year', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '01/24/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-01-24 00:00:00.000','Chinese New Year', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '04/06/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-04-06 00:00:00.000','Good Friday', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '05/01/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-05-01 00:00:00.000','Labour Day', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '05/05/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-05-05 00:00:00.000','Vesak Day', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '08/09/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-08-09 00:00:00.000','National Day', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '08/20/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-08-20 00:00:00.000','Hari Raya Puasa', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '10/26/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-10-26 00:00:00.000','Hari Raya Haji', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '11/13/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-11-13 00:00:00.000','Deepavali', -1)
END

SET @count = 0
Select @count = count(id) from public_holidays where holiday_date = '12/25/2012'
if (@count = 0)
Begin 
	INSERT INTO dbo.public_holidays ( holiday_date, holiday_name, companyid ) VALUES  ( '2012-12-25 00:00:00.000','Christmas Day', -1)
END
	...
	Insert Into Cpf_Calcs (age_from, age_to, pr_year, emp_group, employer_cpf, employee_cpf, CPFCalculate) values
						  (51, 55,  3, 1, 12, 18, 4)
	Insert Into Cpf_Calcs (age_from, age_to, pr_year, emp_group, employer_cpf, employee_cpf, CPFCalculate) values
						  (56, 60,  3, 1, 9.0,  12.5, 4)
	Insert Into Cpf_Calcs (age_from, age_to, pr_year, emp_group, employer_cpf, employee_cpf, CPFCalculate) values
						  (61, 65,  3, 1, 6.5, 7.5, 4)
	Insert Into Cpf_Calcs (age_from, age_to, pr_year, emp_group, employer_cpf, employee_cpf, CPFCalculate) values
						  (66, 100, 3, 1, 6.5, 5.0, 4)		
GO
...
Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (1,1,'0','@SAL * .04',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (1,2,'0','(@SAL - 50 )* .0265',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (1,3,'0','(@SAL - 50 )* .0265',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (1,4,'0','(@SAL - 50 )* .0265',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (1,5,'0','(@SAL - 50 )* .0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (1,6,'0','(@SAL - 50 )* .0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (2,1,'(@SAL - 500) * 0.12','@SAL * .04',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (2,2,'(@SAL - 500) * 0.12','(@SAL - 50 )* .0265',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (2,3,'(@SAL - 500) * 0.12','(@SAL - 50 )* .0265',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (2,4,'(@SAL - 500) * 0.12','(@SAL - 50 )* .0265',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (2,5,'(@SAL - 500) * 0.12','(@SAL - 50 )* .0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (2,6,'(@SAL - 500) * 0.12','(@SAL - 50 )* .0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (3,1,'((@SAL - 750) * 0.06)+30','@SAL * .04',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (3,2,'((@SAL - 750) * 0.06)+30','((@SAL -750)  * 0.0541) + 18.60',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (3,3,'((@SAL - 750) * 0.06)+30','((@SAL -750)  * 0.0498) + 18.60',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (3,4,'((@SAL - 750) * 0.06)+30','((@SAL -750)  * 0.044)  + 18.60',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (3,5,'((@SAL - 750) * 0.06)+30','((@SAL -750) * 0.0291 )+ 16.275',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (3,6,'((@SAL - 750) * 0.06)+30','((@SAL -750) * 0.0291 )+ 16.275',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (4,1,'((@SAL - 750) * 0.06)+30','@SAL * .04',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (4,2,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.0568)+ 42.96',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (4,3,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.0632)+ 41.04',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (4,4,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.072 )+ 38.40',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (4,5,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.077 )+ 29.40',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (4,6,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.077 )+ 29.40',4)

	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (5,1,'0','@SAL * 0.09',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (5,2,'0','(@SAL - 50) * 0.0597',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (5,3,'0','(@SAL - 50) * 0.0597',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (5,4,'0','(@SAL - 50) * 0.0398',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (5,5,'0','(@SAL - 50) * 0.0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (5,6,'0','(@SAL - 50) * 0.0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (6,1,'(@SAL - 500) * 0.36','@SAL * 0.09',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (6,2,'(@SAL - 500) * 0.36','(@SAL - 50) * 0.0597',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (6,3,'(@SAL - 500) * 0.36','(@SAL - 50) * 0.0597',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (6,4,'(@SAL - 500) * 0.3','(@SAL - 50) * 0.0398',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (6,5,'(@SAL - 500) * 0.18','(@SAL - 50) * 0.0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (6,6,'(@SAL - 500) * 0.12','(@SAL - 50) * 0.0232',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (7,1,'((@SAL - 750) * 0.18)+90','@SAL * 0.09',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (7,2,'((@SAL - 750) * 0.18)+90','((@SAL -750) * 0.1219 )+ 41.85',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (7,3,'((@SAL - 750) * 0.18)+90',' ((@SAL -750) * 0.1126)+ 41.85',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (7,4,'((@SAL - 750) * 0.15)+75','((@SAL -750) * 0.066 )+27.90',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (7,5,'((@SAL - 750) * 0.09)+45','((@SAL -750) * 0.0291 )+ 16.275',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (7,6,'((@SAL - 750) * 0.06)+30','((@SAL -750) * 0.0291 )+ 16.275',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (8,1,'((@SAL - 750) * 0.18)+90','@SAL * 0.09',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (8,2,'((@SAL - 750) * 0.18)+90','((@SAL -1200) * 0.1276)+96.72',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (8,3,'((@SAL - 750) * 0.18)+90','((@SAL -1200) * 0.1416)+ 92.52',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (8,4,'((@SAL - 750) * 0.15)+75','((@SAL -1200) * 0.108)  + 57.60',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (8,5,'((@SAL - 750) * 0.09)+45','((@SAL -1200) * 0.077 )+29.40',4)
	 Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (8,6,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.077 )+29.40',4)

	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (9,1,'0','@SAL * 0.16',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (9,2,'0','(@SAL - 50) * 0.1063',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (9,3,'0','(@SAL - 50) * 0.0797',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (9,4,'0','(@SAL - 50) * 0.0597',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (9,5,'0','(@SAL - 50) * 0.0431',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (9,6,'0','(@SAL - 50) * 0.0431',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (10,1,'(@SAL - 500) * 0.48','@SAL * 0.16',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (10,2,'(@SAL - 500) * 0.48','(@SAL - 50) * 0.1063',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (10,3,'(@SAL - 500) * 0.432','(@SAL - 50) * 0.0797',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (10,4,'(@SAL - 500) * 0.3','(@SAL - 50) * 0.0597',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (10,5,'(@SAL - 500) * 0.18','(@SAL - 50) * 0.0431',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (10,6,'(@SAL - 500) * 0.12','(@SAL - 50) * 0.0431',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (11,1,'((@SAL - 750) * 0.24)+120','@SAL * 0.16',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (11,2,'((@SAL - 750) * 0.24)+120','((@SAL -750) * 0.2171)+74.475',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (11,3,'((@SAL - 750) * 0.216)+108','((@SAL -750) * 0.1504)+55.8',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (11,4,'((@SAL - 750) * 0.15)+75','((@SAL -750) * 0.099)+41.85',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (11,5,'((@SAL - 750) * 0.09)+45','((@SAL -750) * 0.0541 )+30.225',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (11,6,'((@SAL - 750) * 0.06)+30','((@SAL -750) * 0.0541)+30.225',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (12,1,'((@SAL - 750) * 0.24)+120','@SAL * 0.16',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (12,2,'((@SAL - 750) * 0.24)+120','((@SAL -1200) * 0.226)+ 172.2',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (12,3,'((@SAL - 750) * 0.216)+108','((@SAL -1200) * 0.1884)+ 123.48',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (12,4,'((@SAL - 750) * 0.15)+75','((@SAL -1200) * 0.162)+86.4',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (12,5,'((@SAL - 750) * 0.09)+45','((@SAL -1200) * 0.143)+54.6',4)
	Insert Into CPFAmount_detail (hdr_id, age_group, employee_cpf, employer_cpf, CPFCalculate) values (12,6,'((@SAL - 750) * 0.06)+30','((@SAL -1200) * 0.143 )+54.6',4)
GO
...
GO
if not exists(select * from Deductions_Types where [desc]='CDAC -A' And Company_ID=-1) Insert Into Deductions_Types values ('CDAC -A',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='CDAC -M' And Company_ID=-1) Insert Into Deductions_Types values ('CDAC -M',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='ECF  -A' And Company_ID=-1) Insert Into Deductions_Types values ('ECF  -A',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='ECF  -M' And Company_ID=-1) Insert Into Deductions_Types values ('ECF  -M',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='MBMF -A' And Company_ID=-1) Insert Into Deductions_Types values ('MBMF -A',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='MBMF -M' And Company_ID=-1) Insert Into Deductions_Types values ('MBMF -M',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='SINDA-A' And Company_ID=-1) Insert Into Deductions_Types values ('SINDA-A',-1, 'No','Yes', null,null,null)
if not exists(select * from Deductions_Types where [desc]='SINDA-M' And Company_ID=-1) Insert Into Deductions_Types values ('SINDA-M',-1, 'No','Yes', null,null,null)
GO
Select * Into #GroupRightsTemp From GroupRights Where GroupID In
(Select GroupID from UserGroups Where GroupName != 'Super Admin')
GO
...
Insert Into UserRights values(45,'Roster Assignment','Timesheet','Timesheet',4,3,4,42,null,'Manage Roster Assignment','Right to assign employees to roaster',1)
Insert Into UserRights values(46,'Automatic Timesheet','Timesheet','Timesheet',4,4,5,42,null,'Import Timesheet','Right to import timesheet from external source',1)
Insert Into UserRights values(47,'Manage Employee Timesheet','Timesheet','Timesheet',4,5,7,42,null,'Submit Timesheet - For Employee','Right to submit timesheet for individual employee',1)
Insert Into UserRights values(48,'Manage Project Timesheet','Timesheet','Timesheet',4,6,8,42,null,'Submit Timesheet - For Project','Right to submit timesheet for project (all employees under that project)',1)
Insert Into UserRights values(49,'Submit Timesheet for All','Timesheet','Timesheet',null,null,9,42,null,'Submit Timesheet For All','Right to submit timesheet for all',1)
Insert Into UserRights values(50,'Approve Timesheet','Timesheet','Timesheet',null,null,10,42,null,'Approve Timesheet','Right to approve, Reject or Delete timesheet',1)
Insert Into UserRights values(51,'Approve Timesheet for All','Timesheet','Timesheet',null,null,11,42,null,'Approve Timesheet For All','Right to approve, Reject or Delete timesheet for all',1)
--Insert Into UserRights values(52,'Compare Timesheet','Timesheet','Timesheet',4,7,12,42,null,'Compare Timesheet ( Automatic & Manual)','Right to view compare timesheet',1)
Insert Into UserRights values(212,'View Timesheet','Timesheet','Timesheet',null,null,6,42,null,'View Timesheet','View Employee / Project Timesheet for all',1)
...
delete from UserRights where Rightid='153' -- removed Top menu Admin-->Import Employee
...
------********************************************* Invoice Module *********************************************
Insert Into UserRights values(163,'Invoice Management','Invoice','Invoice',null,null,null,null,null,'Invoicing Module','Right to the main invoicing module',1)
Insert Into UserRights values(212,'Manage Clients','Invoice','Invoice',10,1,2,163,null,'Manage Clients',' Right to manage Client',1)
Insert Into UserRights values(213,'Manage Quotation','Invoice','Invoice',10,2,3,163,null,'Manage Quotation','Right to add, edit or delete Quotation',1)
Insert Into UserRights values(214,'Manage Order','Invoice','Invoice',10,3,4,163,null,'Manage Order','Right to create / Edit Order',1)
Insert Into UserRights values(215,'Manage Invoice','Invoice','Invoice',10,4,5,163,null,'Manage Invoice','Right to View / Print Invoice',1)
Insert Into UserRights values(216,'Manage Preference','Invoice','Invoice',10,5,6,163,null,'Manage Preference','Right to manage Preference',1)

--Insert Into UserRights values(217,'Create Invoice','Invoice','Invoice',10,6,7,163,null,'Create Invoice','Right to create / Edit Invoice',1)
--Insert Into UserRights values(218,'Print Invoice','Invoice','Invoice',10,7,8,163,null,'Print Invoice','Right to View / Print Invoice',1)
--Insert Into UserRights values(219,'Payment Management','Invoice','Invoice',10,8,9,163,null,'Payment Management','Right to Add / Edit Or Delete Payments',1)

Insert Into UserRights values(213,'Payment Type','Admin','Invoice Managements',null,null,60,169,null,'Payment Type','Payment Type To invoice',2)


--bottom.aspx

Insert Into UserRights values(300,'EMPLOYEE NAME','Reminders','Reminders',0,null,12,1,null,'Employee Name on Footer','Right to view employe Name on Footer',2)
Insert Into UserRights values(301,'EMPLOYEE GROUP','Reminders','Footer',0,null,13,1,null,'Employee Group on Footer','Right to view Employee Group on Footer',2)
Insert Into UserRights values(302,'USER NAME','Reminders','Footer',0,null,14,1,null,'User Name on Footer','Right to view User Name on Footer',2)
Insert Into UserRights values(303,'LAST BACKUP','Reminders','Footer',0,null,15,1,null,'Last Backup on Footer','Right to view Last Backup Info on Footer',2)
Insert Into UserRights values(304,'LICENSE INFO','Reminders','Footer',0,null,16,1,null,'Licence Info on Footer','Right to view Licence Info on Footer',2)
Insert Into UserRights values(305,'MAINTENANC EXPIRY','Reminders','Footer',0,null,17,1,null,'Maintenance Expiry on Footer','Right to view Maintenance Expiry on Footer',2)
...
---GO
---INSERT INTO [Report_Preference] ([Type],[HeaderUrl],[HeaderPopUpUrl],[FooterUrl],[FooterPopUpUrl]) 
--VALUES('Invoice','','','','')
--GO

------For  CPF 2011 Changes
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
----Insert Data in to new table
DELETE  from Company_CPF_CEILING
GO



INSERT INTO [dbo].[Company_CPF_CEILING]
           ([monthly_cpf_celi]
           ,[annual_cpf_ceil]
           ,[EffectiveDateFrom]
           ,[EffectiveDateTo])
     VALUES
           (4500,54000,'09/01/2005','08/31/2011')
...
INSERT INTO [dbo].[Company_CPF_CEILING]
           ...
           ,[EffectiveDateTo])
     VALUES
           (5000,60000,'09/01/2011','08/31/2020')

GO

------------------------Changes for Additional Wages ----------------------------------------------------------------------------------------------------------------------------------------------------
--------From 01 JAN 2005 till 31 Aug 2011
DELETE FROM CPF_AdditionalWages_CEILING
GO

INSERT INTO [dbo].[CPF_AdditionalWages_CEILING]
           ([Additional_Wage_Ceiling]
           ,[EffectiveDateFrom]
           ,[EffectiveDateTo])
     VALUES
           (76500,'09/01/2005','08/31/2011')
...
INSERT INTO [dbo].[CPF_AdditionalWages_CEILING]
           ...
           ,[EffectiveDateTo])
     VALUES
           (85000,'01/01/2012','12/31/2013')
GO

----------------------------------------------------------------------------------------------------------------------------------------------------------------------

-- Query Need to run for One Time 
...
-- I.[Remarks], I.ID As ID_FK FROM ACTATEK_LOGS I
-- INNER JOIN SubProject B ON I.terminalSN = B.Sub_Project_ID
-- GO	
	
-- GO
-- For SubprojectProxy Records
-- INSERT INTO dbo.ACTATEK_LOGS_PROXY([userID],[timeentry],[eventID],[terminalSN],[jpegPhoto],[company_id],[tranid],[Inserted],[softdelete],[NightShift],[SessionID] ,[Roster_ID] ,[Remarks], [ID_FK])
...
-- GO
-- SELECT * FROM ACTATEK_LOGS WHERE ID NOT IN 
-- (
--		SELECT I.ID FROM ACTATEK_LOGS I
--		INNER JOIN SubProject B ON I.terminalSN = B.Sub_Project_ID
--  )
-- GO
...
-----Invoice-----------------
GO
DELETE FROM Variable_Type

GO

INSERT INTO [Variable_Type] ([VarId],[Type])VALUES ('1','Addition')
INSERT INTO [Variable_Type] ([VarId],[Type])VALUES ('2','Deduction')

GO
declare @companyid int
declare sampcursor1_1 cursor for select [company_id] from company
open sampcursor1_1
fetch next from sampcursor1_1 into @companyid
while @@fetch_status = 0
begin
	...
	BEGIN                    
		DECLARE @exists INT                    
		SET @exists = 0                    
		SELECT @exists = COUNT(company_id) FROM StartNumber where company_id = @companyid
	 IF @exists <= 0                    
	 BEGIN                    
		INSERT INTO [StartNumber]([Desc],[Prefix],[StartNumber],[Company_id])VALUES                             
		 ('Quotation','ANB\sg1\','1000',@companyid)  
      INSERT INTO [StartNumber]([Desc],[Prefix],[StartNumber],[Company_id])VALUES                             
		 ('Order','ORD\sg1\','10000',@companyid) 
		--print @companyid
	 END                     
	END                     
fetch next from sampcursor1_1 into @companyid
...
-- Employee Module ------------
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '1') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('1','Employee List','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '2') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('2','Employee Group Management','','1')
END
GO
-- End  Employee Module ------------
----Home page -----------------------
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '10') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('10','Employees On Leave','','1')
END
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '11') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('11','Pending leave Requests','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '12') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('12','Passes Expiring','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '13') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('13','Passport Expiring','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '14') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('14','CSOC Expiring','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '15') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('15','Insurance Expiring','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '16') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('16','Employee Birthday','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '17') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('17','Probation Period Expiring','','1')
END
GO
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '18') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('18','Other Certificates Expiring','','1')
END
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '19') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('19','Year Of Service','','1')
END
GO
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '20') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('20','Backup Information','','1')
END
GO
----End Home page -----------------------
------Payroll -----------------------------
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '100') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('100','Payroll Additions','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '101') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('101','Payroll Deductions','','1')
END
GO 
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '102') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('102','Employee Overtime','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '103') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('103','Submit Payroll','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '104') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('104','Approve Payroll','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '105') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('105','Generate Payroll','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '106') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('106','Print Payroll','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '107') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('107','Unlock Payroll','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '108') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('108','Employee Multi Additions','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '109') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('109','Employee Multi Deductions','','1')
END
GO 
IF NOT EXISTS ( Select * from GridHeader where GridNo  = '110') 
BEGIN
  INSERT INTO [dbo].[GridHeader]([GridNo],[ReportName],[Other],[GenerateBy]) VALUES ('110','Print Payroll','','1')
END
GO 
------End Payroll --------------------------
-- Grid header END ---------------------------
------Insert blank record for multi addition --excel import
Go
GO
declare @companyid int
declare sampcursor1_1 cursor for select [company_id] from company
...
begin
	...
	BEGIN                    
		DECLARE @exists INT                    
		SET @exists = 0                    
		SELECT @exists = COUNT(company_id) FROM MapAdditions where company_id = @companyid
	 IF @exists <= 0                    
	 BEGIN                    
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A1',@companyid)  
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A2',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A3',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A4',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A5',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A6',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A7',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A8',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A9',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A10',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A11',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A12',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A13',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A14',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A15',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A16',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A17',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A18',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A19',@companyid) 
		INSERT INTO [MapAdditions]([MapVariable],[Company_id])VALUES ('A20',@companyid) 
	 END                     
	END                     
fetch next from sampcursor1_1 into @companyid
end
...
begin
	...
	BEGIN                    
		DECLARE @exists INT                    
		SET @exists = 0                    
		SELECT @exists = COUNT(company_id) FROM MapDeductions where company_id = @companyid
	 IF @exists <= 0                    
	 BEGIN                    
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D1',@companyid)  
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D2',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D3',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D4',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D5',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D6',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D7',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D8',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D9',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D10',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D11',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D12',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D13',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D14',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D15',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D16',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D17',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D18',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D19',@companyid) 
		INSERT INTO [MapDeductions]([MapVariable],[Company_id])VALUES ('D20',@companyid) 
	 END                     
	END                     
fetch next from sampcursor1_1 into @companyid
end
...
--------------------------------------------------------------------------------------------------
--GO
--INSERT INTO [GWTMARINE].[dbo].[Report_Settings]
--           ([PAYSLIPFORMAT]
--           ,[NAME]
--           ,[IDNO]
--           ,[SALFORMONTH]
