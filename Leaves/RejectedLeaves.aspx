                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>View Rejected Leaves</b></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
                            <td valign="middle" align="center">
                                ...
                                <asp:DropDownList ID="DropDownList1" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource1"
                                    DataTextField="emp_name" DataValueField="emp_code" Width="143px" CssClass="textfields">
                        ...
                        <radG:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                            ...
                            <MasterTableView DataSourceID="SqlDataSource2" AutoGenerateColumns="False" DataKeyNames="trx_id">
                                ...
                                <Columns>
                                    ...
                                    <radG:GridBoundColumn DataField="Application Date" DataType="System.DateTime" UniqueName="Application Date"
