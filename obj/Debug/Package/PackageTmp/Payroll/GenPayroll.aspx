                                    ...
                                    <tr>
                                        <td>
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tr>
                                                    <td colspan="0">
                                                        <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Generate Payroll</b></font>
                                                    </td>
                                                    <td align="center" >
                                              ...
                                              <%--          <asp:DropDownList ID="cmbYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbYear_selectedIndexChanged"
                                                    ...
                                                    <td>  <input type="button" id="btndetail" runat="server" class="textfields" onclick="showreport(this);" value="View Pay Report" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
               ...
               <%-- OnNeedDataSource="RadGrid1_NeedDataSource"--%>
                 <radG:RadGrid ID="RadGrid1" runat="server"  AllowPaging="true" PageSize="50"
                    ...
                    <MasterTableView DataKeyNames="trx_id,emp_name,emp_id,basic_pay,
                                     Netpay,Additions,AdditionsWONH,Deductions,OT1_e,OT2_e,NH_e,DeptName,time_card_no"   TableLayout="Auto" PagerStyle-Mode="Advanced">
                        ...
                        <Columns> 
                            <radG:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn" HeaderText="105">
                                <ItemTemplate>
                            ...
                            <radG:GridBoundColumn Display="false" DataField="emp_id" HeaderText="Employee Code"
                            ...
                            <radG:GridBoundColumn DataField="DeptName" HeaderText="Department" SortExpression="DeptName"
                                UniqueName="DeptName" ShowFilterIcon="false" AutoPostBackOnFilter="true">
                            </radG:GridBoundColumn>
                        ...
                        <tr>
                            ...
                            <td style="width:60%;color:White;" >
                                <%if (Utility.AllowedAction1(Session["Username"].ToString(), "Generate or Submit Payroll"))
                                  {%>
                                <asp:Button ID="btngenerate" runat="server" Text="Generate Payroll" class="textfields"
                                    Style="width: 240px; height: 23px" OnClick="btngenerate_Click" />
                                <%}%>
                            </td>
                        </tr>
                    </table>
