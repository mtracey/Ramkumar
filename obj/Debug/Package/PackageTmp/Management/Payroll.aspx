                ...
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../Payroll/PayrollAdditions.aspx" class="nav"><b>Payroll Additions </b></a>
                            <br />
                            <tt class="bodytxt">Manage your payroll Additions information. Add new<br />
                                Payroll Additions or update the existing information</tt></td>
                        <%}
                          else
                          {%>
                        <td colspan="2">
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../Payroll/PayrollDeductions.aspx" class="nav"><b>Payroll Deductions </b></a>
                            <br />
                            <tt class="bodytxt">Manage your payroll Deductions information. Add new
                                <br />
                                Payroll Deductions or update the existing information</tt></td>
                        <%}%>
                    </tr>
                    <ul>
                    </ul>
            ...
            <center>
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../employee/emp_overtime.aspx" class="nav"><b>Manage Overtime Pay </b></a>
                            <br />
                            <tt class="bodytxt">Manage overtime pay rate for employee groups.</tt><br />
                        </td>
                        <%}
                          else
                          {%>
            ...
            <center>
                <table border="0" cellpadding="0" cellspacing="5" style="border-collapse: collapse"
                    ...
                    <tr>
                        ...
                        <td style="width: 41%; text-align: left">
                            <a href="../Payroll/Emp_BulkAdd.aspx" class="nav"><b>Multi Additions</b></a>
                            <br />
                        ...
                        <td style="width: 9%" align="left">
                            <img alt="" src="../frames/images/Payroll/B-deductions .png" /></td>
                        <td style="width: 41%; text-align: left">
                            <a href="../Payroll/Emp_BulkDed.aspx" class="nav"><b>Multi Deductions</b></a>
                            <br />
