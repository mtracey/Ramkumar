...
<body style="margin-left: auto" >
    <form id="employeeform" runat="server" method="post">
        ...
        <!-- pop up  -->
            ...
            <div>
                 <telerik:RadWindow ID="radWindow1" skin="Outlook" 
                                                            ...
                                                            <tr class="trstandtop">
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="btnSB" runat="server" Text="Add" OnClientClick="return submitforSB();"
                                                                        OnClick="btnSB_Click" Width="150px" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100%" colspan="4">
                                                                    <radG:RadGrid ID="RadGrid10" runat="server" Width="100%" AllowFilteringByColumn="true"  OnDeleteCommand="RadGrid10_DeleteCommand"
                                                    ...
                                                    <td valign="top">
                                                        <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                                            ...
                                                            <tr class="trstandbottom">
                                                                ...
                                                                <td>
                                                                    <label id="lblProbationperiod" runat="server"></label>                                                                    
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <table style="border: 0; width: 100%;" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <%--    <asp:DropDownList ID="drpYear" AutoPostBack="true" runat="server" OnSelectedIndexChanged="drpYear_SelectedIndexChanged">
                                                                                ...
                                                                                <asp:DropDownList ID="drpYear" DataTextField="text" DataValueField="id" DataSourceID="xmldtYear" AutoPostBack="true" OnSelectedIndexChanged="drpYear_SelectedIndexChanged" 
                                                            ...
                                                            <tr>
                                                                <td colspan="3" align="left">
                                                                    <radG:RadGrid ID="RadGrid9" runat="server" Width="75%" AllowFilteringByColumn="true"
                                                                        DataSourceID="SqlDataSource13" AllowSorting="true" Skin="Outlook" MasterTableView-CommandItemDisplay="bottom"
                                                                        MasterTableView-AllowAutomaticUpdates="true" MasterTableView-AutoGenerateColumns="false"
                                                                        MasterTableView-AllowAutomaticInserts="true" MasterTableView-AllowMultiColumnSorting="true"
                                                                        GroupHeaderItemStyle-HorizontalAlign="left" ClientSettings-EnableRowHoverStyle="true"
                                                                        ClientSettings-AllowColumnsReorder="true" ClientSettings-ReorderColumnsOnClient="true">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                            ...
                                                            <tr class="trstandbottom">
                                                                <td>
                                                                    <tt class="required">*</tt>Effective Date:
                                                                </td>
                                                                <td>
                                                                    Pay Frequency:
                                                                </td>
                                                            ...
                                                            <tr class="trstandtop">
                                                                <td>
                                                                    <radCln:RadDatePicker Calendar-ShowRowHeaders="false" MinDate="01-01-1900" ID="rdFrom"
                                                                        ...
                                                                        <DateInput ID="DateInput12" runat="server" Skin="" DateFormat="MMMM, yyyy">
                                                                        </DateInput>
                                                                ...
                                                                <td>
                                                                    <select id="drpPayFrequency" runat="server" class="textfields" style="width: 120px"   onchange="ValidatePayRecord()" >
                                                            ...
                                                            <tr class="trstandtop">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox  Style="text-align: right"  ID="custxtOT1Rate" Text="1.5" MaxLength="5"  Width="50px"
                                                                         runat="server" onkeyup="javascript:CalculateOTRateCust(this);"
                                                                        onkeypress="return isNumericKeyStrokeDecimal(event)" > </asp:TextBox><tt class="bodytxt">&nbsp;
                                                                        <%--<asp:Label ID="cuslbltxtOt1Rate" runat="server"></asp:Label>--%></tt>
                                                                    <asp:TextBox ID="txtManualOT1" runat="server" Width="50px" MaxLength="5" onkeyup="javascript:CalculateOTRateManual(this);" onkeypress="return isNumericKeyStrokeDecimal(event)"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox Style="text-align: right" MaxLength="5" ID="custxtOT2Rate" Text="2"
                                                                        Width="50px" runat="server" onkeyup="javascript:CalculateOTRateCust(this);"
                                                                        onkeypress="return isNumericKeyStrokeDecimal(event)"> </asp:TextBox><tt class="bodytxt">&nbsp;
                                                                        <%--<asp:Label   ID="cuslbltxtOt2Rate" runat="server"></asp:Label>--%></tt>
                                                                        <asp:TextBox ID="txtManualOT2" runat="server" Width="50px"   MaxLength="5" onkeyup="javascript:CalculateOTRateManual(this);" onkeypress="return isNumericKeyStrokeDecimal(event)"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                                <td>
...
//			    sMSG += "Secondary Bank Info-Giro Bank\n";
	    ...
	    function ValidateForm()
	    {
		    ...
		    msg     =   msg +    "Personal Info-Employer CPF Ref Number,Job Info-Joining Date,Job Info-Date of Birth,Salary Info-Employee Pass Type";
		    msg     =   msg +    ",Primary Bank Info-Pay Mode,Salary Info-Race";
            ...
            strirmsg="";
            strirmsg = CompareDateToday(selectDate,"14","<","Job Info-Employee should not be below\n");            
            if(strirmsg!="")
                sMSG += strirmsg; 
...
//			    sMSG += "Job Info-Confirmation Date\n";	
		    ...
		    if ( !document.getElementById("rdJoiningDate").value == false)
		    {
                ...
                if (tyear2 != null) 
                {
                    if ( (tyear1.getFullYear()-tyear2.getFullYear()) < 14)
                    {
		                sMSG += "Job Info-Employee should not be below 14 years.\n";	
                    }
                }
