                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td width="100%" align="left">
                                ...
                                <img alt="Employee" src="../frames/images/home/B-reminders.png" />&nbsp;<font face="verdana"
                                    size="2">Employees On Leave<%--<a href="..\leaves\leaveCalendar.aspx">Leave Calendar</a>--%></font><hr
                                        color="lightgrey" width="300" align="left">
                                <%}%>
                            </td>
                        </tr>
                        <tr>
                          ...
                          {%>
                            ...
                            <radG:RadGrid ID="RadGrid6" runat="server" GridLines="Both" Skin="Outlook" AllowPaging="True"
                                OnGridExporting="RadGrid6_GridExporting" AutoGenerateColumns="true" OnItemDataBound="RadGrid1_ItemDataBound"
                                ItemStyle-Wrap="true" AlternatingItemStyle-Wrap="true">
                        ...
                        <tr>
                            <td width="100%" align="left" valign="top">
                              ...
                              {%>
                                ...
                                <!-- tool bar end -->
                                <!-- -->
                                <radG:RadGrid ID="RadGrid1" runat="server" GridLines="Both" Skin="Outlook" AllowPaging="True"
                                    OnGridExporting="RadGrid1_GridExporting" OnItemDataBound="RadGrid2_ItemDataBound">
                                    <FilterItemStyle HorizontalAlign="left" />
                                    <HeaderStyle ForeColor="Navy" />
                                    <ItemStyle BackColor="White" Height="20px" />
                                    <AlternatingItemStyle BackColor="#E5E5E5" Height="20px" />
                        ...
                        <tr>
                          ...
                          {%>
                            ...
                            <radG:RadGrid ID="RadGrid7" runat="server" GridLines="Both" Skin="Outlook" AllowPaging="True"
                                OnGridExporting="RadGrid7_GridExporting" PageSize="4" PagerStyle-Visible="false"
                        ...
                        <tr>
                           <td align="right" style="font-family: Verdana; font-size: 8pt">
                            <%if (Utility.AllowedAction1(Session["Username"].ToString(), "View Birthday Dates"))
                          {%>
                            <a href="#" onclick="return ShowInsertForm(80);">...More</a>
                            <%}%>
                        </td> 
                        </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                             ...
                             <%if (Utility.AllowedAction1(Session["Username"].ToString(), "View Pending Leaves"))
                              {%>
                                <img alt="Users" src="../frames/images/home/B-reminders.png" />&nbsp;<font face="verdana"
                                    size="2">Pending leave Requests</font><hr color="lightgrey" width="300" align="left">
                              <%}%>
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="100%" align="left">
                              ...
                              {%>
                                <img alt="Users" src="../frames/images/home/B-reminders.png" />
                                <font face="verdana" size="2">Year Of Service </font>
                                <hr align="left" width="300" color="lightgrey" />
                                <%}%>
                           </td> 
                        </tr>
